...
namespace Task
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine(newSnail.ToString());
                var ading = ParseRecuriveley(lines[i], 0, null);
                newSnail = AddTwoPairs(newSnail, ading);
                ...
                while (toExplode != null || toSplit != null)
                {
                    if (toExplode != null)
                    {
                        Console.WriteLine("To Explode {0}", toExplode.ToString());
                        toExplode.Explode();
                        Console.WriteLine(newSnail.ToString());
                    ...
                    {
                        Console.WriteLine(newSnail.ToString());
                        Console.WriteLine("To Split {0}", toSplit.ToString());
                        toSplit.Split();
                        Console.WriteLine(newSnail.ToString());
                    }
            ...
            Console.WriteLine("Result is {0} ", newSnail.FindMagnitude());
