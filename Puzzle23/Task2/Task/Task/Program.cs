...
public class Puzzle23 
{
    ...
    private static Amphipod[] rooms;
    private static Amphipod[] hallway;
    ...
    private static void Run(int energy, int count)
    {
    ...
    private static List<(int, int, int)> GetMoves(int[] solved)
    {
    ...
    private static int MinimumEnergy()
    {
        int energy = 0;
        for (int i = 0; i < 7; i++)
        {
    ...
    private static void PathsToHallway(List<(int, int, int)> moves, int r, int d, int t)
    {
    ...
    private static (int, int) PathToRoom(int[] solved, int h, int r)
    {
    ...
    private static int[] RoomsSolved(int max)
    {
    ...
    {
        public static readonly Amphipod EMPTY = new Amphipod() { Type = -1 } ;
        public int Type;
